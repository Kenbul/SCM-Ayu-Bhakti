<template>
    <AppLayout title="Edit Barang Keluar">
...
const props = defineProps({
    outgoing_good: Object,
    items: Array
})

const form = useForm({
    item_id: props.outgoing_good.item_id,
    quantity: props.outgoing_good.quantity,
    date_out: props.outgoing_good.date_out,
    destination: props.outgoing_good.destination
})

const submit = () => {
    form.put(`/outgoing-goods/${props.outgoing_good.id}`, {
        onSuccess: () => {
            Toast.fire({
                icon: 'success',
